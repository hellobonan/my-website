...
export default function Home() {
  ...
  const selectedEssayTranslation = [...essayTranslations, ...longEssayTranslations].find((essay) => essay.id === selectedEssayId) || null;
  const selectedEnglishStory = (englishStories as EnglishStory[]).find((story) => story.id === selectedEssayId) || null;
