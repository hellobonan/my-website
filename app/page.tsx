...
type Essay = { id: string; title: string; category: string; excerpt: string; body: string; image?: string };
...
const requestedBookTitles = `Crucial Conversations|Never Split the Difference|You're the Boss|Leadership and Self-Deception|What Got You Here Won't Get You There|Magic Words|The Power of Now|How to Win Friends and Influence People|Third Millennium Thinking|How to Stop Worrying and Start Living|Outlive|The Game of Life and How to Play It|Surrounded by Idiots|Outliers|Thinking, Fast and Slow|Same as Ever|Behave|Factfulness|The Prophet|The Almanack of Naval Ravikant|Daring Greatly|Algorithms to Live By|How to Love Someone Without Losing Your Mind|The Score Takes Care of Itself|Lateral Thinking|The Winning Attitude|The Code of Trust|Dare to Lead|Leaders Eat Last|How to Start a Business on Your Kitchen Table|Superforecasting|Working Backwards|Radical Candor|The Goal|BE 2.0|Drive|The Five Dysfunctions of a Team|Multipliers|Good to Great|The Most Human Human|Trillion Dollar Coach|The Carpenter|The Berry Pickers|Influence, New and Expanded|Ego Is the Enemy|Talk Like TED|Designing Your Life|How to Talk to Anyone|The Elements of Style|Scarcity|The Magic of Thinking Big|The Obstacle Is the Way|The First 90 Days|Difficult Conversations|Measure What Matters|Choose Your Story, Change Your Life|The Lean Startup|The Ride of a Lifetime|Centered Leadership|Negotiating the Nonnegotiable|Crack the C-Suite Code|Make Yourself Clear|The Intelligent Investor|You Are the Placebo|Proof of Heaven|Secrets of Sand|Principles: Life and Work|An Uncommon Dialogue|Bad Blood|Start with Why|The Power of Habit|Do I Make Myself Clear?|Originals|Maybe You Should Talk to Someone|Fall in Love with the Problem, Not the Solution|The Five Love Languages|The Social Animal|Nonviolent Communication|Mindful Parenting|Replay|The Practice of Management|Toyota Production System`.split("|");

const bookCorrections: Partial<Record<string,{ author: string; isbn: string; amazon: string; cover?: string }>> = {
  "How to Start a Business on Your Kitchen Table": { author: "Shann Nix Jones", isbn: "", amazon: "https://www.amazon.com/dp/B07Y7GMZT6", cover: "/media/books/kitchen-table.png" },
  "Lateral Thinking": { author: "Edward de Bono", isbn: "9780060903251", amazon: "https://www.amazon.com/dp/0060903252", cover: "/media/books/lateral-thinking.png" },
  "How to Love Someone Without Losing Your Mind": { author: "Todd Baratz, LMHC", isbn: "9780593581193", amazon: "https://www.amazon.com/dp/0593581199", cover: "/media/books/love-without-losing.png" },
  "Magic Words": { author: "Jonah Berger", isbn: "9780063204935", amazon: "https://www.amazon.com/dp/0063204932", cover: "/media/books/magic-words.png" },
  "Range": { author: "David Epstein", isbn: "9780735214507", amazon: "https://www.amazon.com/dp/0735214506", cover: "/media/books/range.png" },
  "Think Again": { author: "Adam Grant", isbn: "9781984878120", amazon: "https://www.amazon.com/dp/1984878123", cover: "/media/books/think-again.png" },
  "The Creative Act": { author: "Rick Rubin", isbn: "9780593653166", amazon: "https://www.amazon.com/s?k=The+Creative+Act+Rick+Rubin", cover: "/media/books/creative-act.png" },
  "The Coming Wave": { author: "Mustafa Suleyman with Michael Bhaskar", isbn: "9780593593950", amazon: "https://www.amazon.com/s?k=The+Coming+Wave+Mustafa+Suleyman", cover: "/media/books/coming-wave.png" },
  "You're the Boss": { author: "Sabina Nawaz", isbn: "", amazon: "https://www.amazon.com/s?k=You%27re+the+Boss+Sabina+Nawaz", cover: "/media/books/youre-the-boss.png" },
  "The Power of Now": { author: "Eckhart Tolle", isbn: "", amazon: "https://www.amazon.com/s?k=The+Power+of+Now+Eckhart+Tolle", cover: "/media/books/power-of-now.png" },
  "How to Win Friends and Influence People": { author: "Dale Carnegie", isbn: "", amazon: "https://www.amazon.com/s?k=How+to+Win+Friends+and+Influence+People+Dale+Carnegie", cover: "/media/books/win-friends.png" },
  "The Game of Life and How to Play It": { author: "Florence Scovel Shinn", isbn: "", amazon: "https://www.amazon.com/s?k=The+Game+of+Life+and+How+to+Play+It+Florence+Scovel+Shinn", cover: "/media/books/game-of-life.png" },
  "Outliers": { author: "Malcolm Gladwell", isbn: "", amazon: "https://www.amazon.com/s?k=Outliers+Malcolm+Gladwell", cover: "/media/books/outliers.png" },
  "The Prophet": { author: "Kahlil Gibran", isbn: "", amazon: "https://www.amazon.com/s?k=The+Prophet+Kahlil+Gibran", cover: "/media/books/the-prophet.png" },
  "The Almanack of Naval Ravikant": { author: "Eric Jorgenson", isbn: "", amazon: "https://www.amazon.com/s?k=The+Almanack+of+Naval+Ravikant", cover: "/media/books/naval-almanack.png" },
  "BE 2.0": { author: "Jim Collins & Bill Lazier", isbn: "", amazon: "https://www.amazon.com/s?k=BE+2.0+Jim+Collins+Bill+Lazier", cover: "/media/books/be-2.png" },
  "The Carpenter": { author: "Jon Gordon", isbn: "9780470888544", amazon: "https://www.amazon.com/s?k=The+Carpenter+Jon+Gordon", cover: "/media/books/carpenter.png" },
  "The Elements of Style": { author: "William Strunk Jr. & E. B. White", isbn: "", amazon: "https://www.amazon.com/s?k=The+Elements+of+Style+Strunk+White", cover: "/media/books/elements-of-style.png" },
  "The First 90 Days": { author: "Michael D. Watkins", isbn: "", amazon: "https://www.amazon.com/s?k=The+First+90+Days+Michael+Watkins", cover: "/media/books/first-90-days.png" },
  "Difficult Conversations": { author: "Douglas Stone, Bruce Patton & Sheila Heen", isbn: "", amazon: "https://www.amazon.com/s?k=Difficult+Conversations+Stone+Patton+Heen", cover: "/media/books/difficult-conversations.png" },
  ...
  "Choose Your Story, Change Your Life": { author: "Kindra Hall", isbn: "9781400228485", amazon: "https://www.amazon.com/dp/B0912L9BPD", cover: "/media/books/choose-your-story.png" },
  "Centered Leadership": { author: "Joanna Barsh & Johanne Lavoie", isbn: "", amazon: "https://www.amazon.com/s?k=Centered+Leadership+Joanna+Barsh", cover: "/media/books/centered-leadership.png" },
  "The Intelligent Investor": { author: "Benjamin Graham", isbn: "", amazon: "https://www.amazon.com/s?k=The+Intelligent+Investor+Benjamin+Graham", cover: "/media/books/intelligent-investor.png" },
  "Proof of Heaven": { author: "Eben Alexander, M.D.", isbn: "", amazon: "https://www.amazon.com/s?k=Proof+of+Heaven+Eben+Alexander", cover: "/media/books/proof-of-heaven.png" },
  ...
  "Principles: Life and Work": { author: "Ray Dalio", isbn: "9781501124020", amazon: "https://www.amazon.com/dp/B074B2CZJG", cover: "/media/books/principles-life-work.png" },
  "An Uncommon Dialogue": { author: "Neale Donald Walsch", isbn: "", amazon: "https://www.amazon.com/s?k=Conversations+with+God+An+Uncommon+Dialogue", cover: "/media/books/uncommon-dialogue.png" },
  "Bad Blood": { author: "John Carreyrou", isbn: "", amazon: "https://www.amazon.com/s?k=Bad+Blood+John+Carreyrou", cover: "/media/books/bad-blood.png" },
  "The Power of Habit": { author: "Charles Duhigg", isbn: "", amazon: "https://www.amazon.com/s?k=The+Power+of+Habit+Charles+Duhigg", cover: "/media/books/power-of-habit.png" },
  "Do I Make Myself Clear?": { author: "Harold Evans", isbn: "9780316509190", amazon: "https://www.amazon.com/dp/B01G1K1RQS", cover: "/media/books/make-myself-clear.png" },
  "Originals": { author: "Adam Grant", isbn: "9780143128854", amazon: "https://www.amazon.com/dp/014312885X" },
  "The Five Love Languages": { author: "Gary Chapman", isbn: "", amazon: "https://www.amazon.com/s?k=The+Five+Love+Languages+Gary+Chapman", cover: "/media/books/five-love-languages.png" },
  "Nonviolent Communication": { author: "Marshall B. Rosenberg, PhD", isbn: "", amazon: "https://www.amazon.com/s?k=Nonviolent+Communication+Marshall+Rosenberg", cover: "/media/books/nonviolent-communication.png" },
  "Mindful Parenting": { author: "Hunter Clarke-Fields, MSAE", isbn: "", amazon: "https://www.amazon.com/s?k=Raising+Good+Humans+Hunter+Clarke-Fields", cover: "/media/books/mindful-parenting.png" },
  "The Practice of Management": { author: "Peter F. Drucker", isbn: "", amazon: "https://www.amazon.com/s?k=The+Practice+of+Management+Peter+Drucker", cover: "/media/books/practice-of-management.png" },
};
...
function displayVideoTitle(video: { title: string; titleEn?: string; category: string }, language: Language, index = 0) { if (language === "zh") return video.title; if (video.titleEn) return video.titleEn; const label = categoryLabels.en[video.category as keyof typeof categoryLabels.en] || "Life"; return `${label} · Visual field note ${String(index + 1).padStart(2, "0")}`; }
...
export default function Home() {
  ...
  const [essaySort, setEssaySort] = useState("newest");
  ...
  useEffect(() => {
    ...
    const sharedStory = params.get("story"); const sharedIdea = params.get("idea");
    if (params.get("lang") === "zh") setLanguage("zh");
    if (sharedStory) setSelectedEssayId(sharedStory);
    if (sharedIdea) setSelectedId(sharedIdea);
  }, []);
  const t = ui[language];
  ...
  const selectedEssayImage = selectedEssay?.image || selectedEnglishStory?.image;
  ...
  const latestSparks = [...douyinCatalog].sort((a, b) => videoDate(b).getTime() - videoDate(a).getTime()).slice(0, 12);
  ...
  const menuItems = [
    ["#top", language === "zh" ? "首页" : "Home"],
    ["#writing", language === "zh" ? "最新文章" : "Latest writing"],
    ["#postcards", language === "zh" ? "世界地图" : "Field Atlas"],
    ["#essays", language === "zh" ? "人间拾光" : "Collected Light"],
    ["#books", language === "zh" ? "博南书单" : "Bookshelf"],
    ...
    <main lang={language === "zh" ? "zh-CN" : "en"}>
      <header className="site-header">
        ...
        <div className="menu-wrap">
          <button className="menu-toggle" type="button" aria-expanded={menuOpen} aria-controls="site-menu-panel" onClick={() => setMenuOpen((open) => !open)}>{language === "zh" ? "浏览" : "Browse"}<span aria-hidden="true">{menuOpen ? "×" : "☰"}</span></button>
          {menuOpen && <nav className="menu-panel" id="site-menu-panel" aria-label={language === "zh" ? "全部栏目" : "All sections"}>{menuItems.map(([href, label], index) => <a href={href} onClick={() => setMenuOpen(false)} key={href}><span>{String(index + 1).padStart(2, "0")}</span>{label}</a>)}</nav>}
        </div>
      ...
      <a className="floating-home" href="#top" aria-label={language === "zh" ? "返回首页" : "Back to home"}><span aria-hidden="true">↑</span><span className="floating-home-label">{language === "zh" ? "首页" : "Home"}</span></a>
      ...
      <section className="featured section-pad" id="featured"><div className="section-label">{t.featuredLabel}</div><div className="featured-grid"><h2>{t.featuredTitle}</h2><div><p>{t.featuredText}</p><button className="text-link text-button" type="button" onClick={() => setSelectedId("constraint")}>{t.readIdea} <span>→</span></button></div></div><Engagement id="featured" language={language} title={t.featuredTitle}/><SectionHome language={language}/></section>
      ...
      <section className="section-pad" id="writing"><div className="section-heading"><div><p className="eyebrow">{t.journal}</p><h2>{t.journalTitle}</h2></div></div>
        ...
        </div><Engagement id="writing" language={language} title={t.journalTitle}/><SectionHome language={language}/>
      </section>
      ...
      <section className="postcards section-pad" id="postcards"><div className="section-heading postcards-heading"><div><p className="eyebrow">{t.postcards}</p><h2>{t.postcardsTitle}</h2></div><p>{t.postcardsText}</p></div>
        <div className="atlas-map"><div className="globe-stage"><div className="globe-controls"><button type="button" onClick={() => setGlobeZoom((z) => Math.min(1.28, z + .1))} aria-label="Zoom in">＋</button><button type="button" onClick={() => setGlobeZoom((z) => Math.max(.8, z - .1))} aria-label="Zoom out">−</button><small>{language === "zh" ? "拖拽旋转地球 · 点击3D地标" : "DRAG THE EARTH · CHOOSE A 3D LANDMARK"}</small></div><div className="globe" style={{ transform: `scale(${globeZoom})`, backgroundPosition: `${50 - globeRotation / 1.8}% center` }} onPointerDown={(event) => { if ((event.target as HTMLElement).closest(".globe-pin")) return; dragStart.current = { x: event.clientX, rotation: globeRotation }; event.currentTarget.setPointerCapture(event.pointerId); }} onPointerMove={(event) => { if (dragStart.current) setGlobeRotation(dragStart.current.rotation + (event.clientX - dragStart.current.x) * .45); }} onPointerUp={() => { dragStart.current = null; }} onWheel={(event) => { event.preventDefault(); setGlobeZoom((z) => Math.max(.8, Math.min(1.28, z - event.deltaY * .001))); }}><div className="globe-grid"/>{globeLocations.map((place) => { const relativeLon = ((place.lon + globeRotation + 540) % 360) - 180; const visible = Math.abs(relativeLon) < 88; const x = 50 + relativeLon / 1.8; const y = 50 - place.lat / 1.8; return <a key={place.key} href={`https://earth.google.com/web/search/${encodeURIComponent(place.landmark)}`} target="_blank" rel="noreferrer" className={`globe-pin landmark-${place.key} ${mapArea === place.key ? "active" : ""}`} style={{ left: `${x}%`, top: `${y}%`, opacity: visible ? 1 : 0, pointerEvents: visible ? "auto" : "none" }} onClick={() => { setMapArea(place.key); setGlobeRotation(-place.lon); }}><i className="landmark-mini"><b>{place.symbol}</b></i><span>{language === "zh" ? place.zh : place.en}</span></a>; })}</div><div className="globe-city-selector">{globeLocations.map((place) => <button type="button" key={place.key} className={mapArea === place.key ? "active" : ""} onClick={() => { setMapArea(place.key); setGlobeRotation(-place.lon); }}><b>{place.symbol}</b><span>{language === "zh" ? place.zh : place.en}</span></button>)}</div><small className="nasa-credit">NASA Blue Marble · Markers share the map projection</small></div>
        ...
        </div><Engagement id="atlas" language={language} title={t.postcardsTitle}/><SectionHome language={language}/>
      </section>
      ...
      <section className="essay-salon section-pad" id="essays">
        ...
        <div className="essay-grid">{filteredEssays.map((essay, index) => {
          ...
          const cardImage = language === "zh" ? ((essay as Essay).image || imageStory?.image) : imageStory?.image;
          const storyId = imageStory?.id || essay.id;
          const storyTitle = englishStory ? englishStory.title : essay.title;
          return <div className="essay-share-item" key={essay.id}><button type="button" onClick={() => setSelectedEssayId(essay.id)} className={`essay-card essay-tone-${(originalIndex % 6) + 1}`}><div className="essay-art">{cardImage ? <><img src={cardImage} alt={storyTitle} loading="lazy"/><time className="essay-date" dateTime={imageStory?.date}><b>{imageStory?.date ? new Date(`${imageStory.date}T12:00:00`).toLocaleString(language === "zh" ? "zh-CN" : "en", { month: "short" }) : ""}</b><span>{imageStory?.date ? new Date(`${imageStory.date}T12:00:00`).getDate() : ""}</span><i>{imageStory?.date ? new Date(`${imageStory.date}T12:00:00`).getFullYear() : ""}</i></time></> : <span>{String(index + 1).padStart(2, "0")}</span>}</div><div className="essay-card-copy"><small>{essayCategories[language][essay.category as keyof typeof essayCategories.en]}{englishStory ? ` | Published ${englishStory.dateLabel}` : ""}</small><h3>{storyTitle}</h3><p>{englishStory ? englishStory.summary : (essay as Essay).excerpt}</p><span>{language === "zh" ? "阅读全文" : "Read full story"} →</span></div></button><SocialShare title={storyTitle} language={language} path={`collected-light/${storyId}/${language}`} compact/></div>;
        })}</div><Engagement id="essays" language={language} title={language === "zh" ? "人间拾光" : "Collected Light"}/><SectionHome language={language}/>
      </section>

      <section className="bookshelf section-pad" id="books"><div className="books-heading"><div><p className="eyebrow">{language === "zh" ? `博南书单 · ${allBooks.length}本` : `Bonan’s bookshelf · ${allBooks.length} books`}</p><h2>{language === "zh" ? "那些改变我提问方式的书。" : "Books that changed the way I ask questions."}</h2></div><p>{language === "zh" ? "按领导力、沟通、决策与系统、人生与自我、思想与故事分类；也可以按书名排序。" : "Browse by leadership, communication, decisions and systems, life and self, or ideas and stories—then sort the shelf by title."}</p></div><div className="book-tools"><input type="search" value={bookQuery} onChange={(event) => { setBookQuery(event.target.value); setVisibleBooks(18); }} placeholder={language === "zh" ? "搜索书名或主题…" : "Search titles or themes…"}/><select value={bookSort} onChange={(event) => setBookSort(event.target.value)} aria-label={language === "zh" ? "书名排序" : "Sort books"}><option value="curated">{language === "zh" ? "精选顺序" : "Curated order"}</option><option value="az">A → Z</option><option value="za">Z → A</option></select><span>{filteredBooks.length} {language === "zh" ? "本书" : "books"}</span></div><div className="book-categories">{["All","Leadership","Communication","Decisions & systems","Life & self","Ideas & stories"].map((category) => <button type="button" className={bookCategory === category ? "active" : ""} onClick={() => { setBookCategory(category); setVisibleBooks(18); }} key={category}>{language === "zh" ? ({ All: "全部", Leadership: "领导力", Communication: "沟通与影响", "Decisions & systems": "决策与系统", "Life & self": "人生与自我", "Ideas & stories": "思想与故事" } as Record<string,string>)[category] : category}</button>)}</div><div className="book-grid">{filteredBooks.slice(0, visibleBooks).map((book) => <article className="book-card" key={book.title}><BookCover title={book.title} isbn={"isbn" in book ? book.isbn : undefined} cover={"cover" in book ? book.cover : undefined}/><div><small>{book.author !== bookTheme(book.title) ? `${book.author} · ` : ""}{bookTheme(book.title)}</small><h3>{book.title}</h3><p><b>{language === "zh" ? "我的短评：" : "Quick review: "}</b>{book[language]}</p><div className="book-links"><a href={"amazon" in book ? book.amazon : `https://www.amazon.com/s?k=${encodeURIComponent(book.title)}`} target="_blank" rel="noreferrer">Amazon ↗</a><a href={`https://www.audible.com/search?keywords=${encodeURIComponent(book.title)}`} target="_blank" rel="noreferrer">Audible ↗</a></div></div></article>)}</div>{visibleBooks < filteredBooks.length && <button className="load-more books-more" type="button" onClick={() => setVisibleBooks((count) => count + 18)}>{language === "zh" ? "继续翻阅" : "Explore more books"} ↓</button>}<Engagement id="books" language={language} title={language === "zh" ? "博南书单" : "Bonan’s bookshelf"}/></section>

      <section className="web-discoveries section-pad" id="web-discoveries"><div className="web-heading"><p className="eyebrow">{language === "zh" ? "有趣的网站" : "Interesting corners of the internet"}</p><h2>{language === "zh" ? "三个重新观看与创造世界的入口。" : "Three portals for seeing—and building—the world differently."}</h2></div><div className="web-grid"><a href="https://anitabi.cn/" target="_blank" rel="noreferrer" className="web-card anime-web"><div className="web-visual"><span>聖地</span><i>2D → REAL WORLD</i></div><div><small>ANIME × MAP</small><h3>AniTABI · 动画巡礼</h3><p>{language === "zh" ? "把动画中的场景与现实地图、街道和取景地对应起来。适合沿着作品去旅行，也适合发现熟悉画面背后的真实城市。" : "Match scenes from anime with their real-world maps, streets, and filming locations—then travel through a story into the city behind it."}</p><b>{language === "zh" ? "打开网站" : "Visit website"} ↗</b></div></a><a href="https://www.skylinewebcams.com/" target="_blank" rel="noreferrer" className="web-card webcam-web"><div className="web-visual"><span>LIVE</span><i>THE WORLD · RIGHT NOW</i></div><div><small>REAL-TIME WINDOWS</small><h3>SkylineWebcams</h3><p>{language === "zh" ? "通过世界各地的实时摄像头，看看此刻的广场、海滩、火山、城市和动物。不是旅行攻略，而是一扇正在发生的窗。" : "Look through live cameras at plazas, beaches, volcanoes, cities, and animals around the world—a window into what is happening right now."}</p><b>{language === "zh" ? "观看实时世界" : "Watch the live world"} ↗</b></div></a><a href="https://www.blueprint.io/" target="_blank" rel="noreferrer" className="web-card blueprint-web"><div className="web-visual"><span>BUILD</span><i>LANGUAGE → HARDWARE</i></div><div><small>AI × ENGINEERING</small><h3>Blueprint</h3><p>{language === "zh" ? "首个从语言到硬件的平台：描述你想制造的无人机、机器人或装置，Blueprint 就会生成可实际构建的完整方案，包括接线、零件清单、机械设计与操作说明。" : "The first language-to-hardware platform. Describe a drone, robot, or gadget, and Blueprint generates a complete buildable plan: wiring, parts list, mechanical design, and instructions."}</p><b>{language === "zh" ? "探索 Blueprint" : "Explore Blueprint"} ↗</b></div></a></div><Engagement id="interesting-websites" language={language}/></section>

      <section className="about section-pad" id="about"><div className="about-copy"><p className="eyebrow">{t.about}</p><h2>{t.aboutTitle}</h2><p className="about-lede">{t.aboutLede}</p><div className="about-columns"><p>{t.aboutA}</p><p>{t.aboutB}</p></div><a className="profile-page-link" href="/bonan-zhong">{language === "zh" ? "查看钟博南的中英文职业简介" : "Read Bonan Zhong’s bilingual professional biography"} →</a>
      ...
      <Engagement id="about" language={language} title={t.aboutTitle}/></div></section>
      ...
      <section className="social-showcase section-pad" id="channels">
        ...
        <div className="channel-block"><div className="channel-title"><div><img src="/media/linkedin-profile.jpg" alt={t.portrait}/><h3>{social.linkedin}</h3></div><a href={linkedinUrl} target="_blank" rel="noreferrer">LinkedIn ↗</a></div>
          <div className="linkedin-grid">{posts.map((post) => <a className="linkedin-card" href={post.url} target="_blank" rel="noreferrer" key={post.url}><img src={post.image} alt=""/><div><h4>{post.title}</h4><p>{post.text}</p><span>{social.open} ↗</span></div></a>)}</div><Engagement id="linkedin" language={language} title={social.linkedin}/>
        </div>
        <div className="channel-block sparks-block"><div className="channel-title"><div><img src="/media/douyin-avatar.jpg" alt="西雅图大南瓜"/><h3>{social.douyin}</h3></div><button className="archive-link-button" type="button" onClick={() => { setShowArchive(true); window.setTimeout(() => document.getElementById("douyin-archive")?.scrollIntoView({ behavior: "smooth", block: "start" }), 50); }}>{social.archive} ↓</button></div>
          <p className="spark-intro">{language === "zh" ? `最新发布的生活片段，以及九个精选瞬间。完整档案收录 ${douyinCatalog.length} 个作品。` : `The latest moments from my life, alongside nine personal highlights. Explore all ${douyinCatalog.length} works in the full archive.`}</p>
          <h3 className="sparks-subheading">{language === "zh" ? "抖音最新发布" : "Latest from Douyin"}</h3>
          <div className="douyin-grid latest-sparks">{latestSparks.map((video, index) => <a className="video-card" href={video.url} target="_blank" rel="noreferrer" key={video.url}><div><img src={video.image} alt={displayVideoTitle(video, language, index)} loading="lazy"/><span className="play-mark" aria-hidden="true">▶</span></div><h4>{displayVideoTitle(video, language, index)}</h4><span>{social.open} ↗</span></a>)}</div>
          <h3 className="sparks-subheading">{language === "zh" ? "九个精选瞬间" : "Nine personal highlights"}</h3>
      ...
      </div><Engagement id="subscribe" language={language} title={t.subscribeTitle}/></section>
